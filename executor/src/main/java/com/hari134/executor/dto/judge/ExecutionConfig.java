...
public class ExecutionConfig {
    ...
    static {
        // Populate the maps with valid languages and their execution commands and file
        // extensions
        LANGUAGE_FILE_EXTENSION_MAP.put(Language.CPP, "cpp");
        LANGUAGE_EXEC_CMD_MAP.put(Language.CPP, "scripts/run/cpp.sh");
    }

    public ExecutionConfig(String correlationId, String language, String code, String timeLimit, String memoryLimit,
        ...
        setExecCmd(langEnum, codeFilePath, timeLimit, memoryLimit, boxId, stdinFilePath, expectedOutputFilePath);
    }
    ...
    private void setExecCmd(Language language, String codeFilePath, String timeLimit, String memoryLimit, String boxId,
            String stdinFilePath, String expectedOutputFilePath) {
        String commandTemplate = LANGUAGE_EXEC_CMD_MAP.get(language);
        ExecCmd execCmd = new ExecCmd(commandTemplate, codeFilePath, timeLimit, memoryLimit, boxId, stdinFilePath,
...
class ExecCmd {
    ...
    public ExecCmd(String commandTemplate, String pathToCodeFile, String timeLimit, String memoryLimit, String boxId,
            String stdinPath, String expectedOutputFile) {
        this.command = buildCommand(commandTemplate, pathToCodeFile, timeLimit, memoryLimit, boxId, stdinPath,
                expectedOutputFile);
    }

    private String buildCommand(String commandTemplate, String pathToCodeFile, String timeLimit, String memoryLimit,
            String boxId, String stdinPath, String expectedOutputFile) {
